...
#define MAX_SIDE 3 // Length of the board 
...
bool rowCrossed(char board[MAX_SIDE][MAX_SIDE]) 
{ 
...
bool columnCrossed(char board[MAX_SIDE][MAX_SIDE]) 
{ 
	for (int i=0; i<MAX_SIDE; i++) 
	{ 
...
bool diagonalCrossed(char board[MAX_SIDE][MAX_SIDE]) 
{ 
...
bool gameOver(char board[MAX_SIDE][MAX_SIDE]) 
{ 
...
int minimax(char board[MAX_SIDE][MAX_SIDE], int depth, bool isAI)
{
	int score = 0;
	int bestScore = 0;
...
int bestMove(char board[MAX_SIDE][MAX_SIDE], int moveIndex)
{
	int x = -1, y = -1;
...
void showBoard(char board[][MAX_SIDE]) 
{ 
...
void generate_board(char board[MAX_SIDE][MAX_SIDE]) 
{	
...
{ 
	...
	while (gameOver(board) == false && moveIndex != MAX_SIDE*MAX_SIDE) 
	{ 
		int n;
		if (whoseTurn == COMPUTER) 
		{
	...
	if (gameOver(board) == false && moveIndex == MAX_SIDE * MAX_SIDE) 
		printf("It's a draw\n"); 
	else
	{ 
